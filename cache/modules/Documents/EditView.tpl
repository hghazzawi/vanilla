...
*}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'my_favorite', 'bool', false,'{/literal}{sugar_translate label='LBL_FAVORITE' module='Documents' for_js=true}{literal}' );
...
addToValidate('EditView', 'name', 'varchar', false,'{/literal}{sugar_translate label='LBL_NAME' module='Documents' for_js=true}{literal}' );
...
addToValidate('EditView', 'doc_owner', 'id', false,'{/literal}{sugar_translate label='LBL_DOC_OWNER' module='Documents' for_js=true}{literal}' );
addToValidate('EditView', 'user_favorites', 'id', false,'{/literal}{sugar_translate label='LBL_USER_FAVORITES' module='Documents' for_js=true}{literal}' );
...
addToValidate('EditView', 'status_id', 'enum', false,'{/literal}{sugar_translate label='LBL_DOC_STATUS_ID' module='Documents' for_js=true}{literal}' );
